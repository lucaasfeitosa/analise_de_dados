...
# 2. Calculando, para cada município do Estado, o total de casos confirmados e o total de óbitos por semana epidemiológica
...
# 3. Enriquecendo a base criada no passo 2 com a população de cada município
...
# 4. Calculando a incidência (casos por 100.000 habitantes) e letalidade (Óbitos por 100.000 habitantes) por município a cada semana epidemiológica.
